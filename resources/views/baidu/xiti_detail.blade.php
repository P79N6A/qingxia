    ...
    <script>
        $(function () {
            ...
            $('#get_search').click(function () {
                ...
                window.location.href = '{{ route('baidu_xiti_detail',[$data['xiti_type'],$data['xiti_id']]) }}' + '/' + time;
            });
            ...
            var myChart1 = new Chart(ctx1, {
                type: 'line',
                data: {
                    labels: {!! $data['xiti_info']->pluck('date_now') !!} ,
                    datasets: [
                        {
                            label: '总访问次数',
                            ...
                            fill: false,
                            hidden: true,
                            data: {!! $data['xiti_info']->pluck('visit_count') !!}
                        },
                        {
                            label: '访客数',
                            ...
                            fill: false,
                            hidden: true,
                            data: {!! $data['xiti_info']->pluck('visitor_count') !!}
                        },
                        {
                            label: '新访客数',
                            ...
                            fill: false,
                            hidden: true,
                            data: {!! $data['xiti_info']->pluck('new_visitor_count') !!}
                        },
                        {
                            label: 'ip数',
                            ...
                            fill: false,
                            hidden: true,
                            data: {!! $data['xiti_info']->pluck('ip_count') !!}
                        },
                        {
                            label: '跳出率',
                            ...
                            fill: false,
                            data: {!! $data['xiti_info']->pluck('bounce_ratio') !!},
                        },
                        {
                            label: '平均访问时长',
                            ...
                            fill: false,
                            hidden: true,
                            data: {!! $data['xiti_info']->pluck('avg_visit_time') !!}
                        },
                    ]
                },
                options: {
