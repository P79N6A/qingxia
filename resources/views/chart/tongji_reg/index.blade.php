...
@push('need_js')
    ...
    <script type="text/javascript">
        $(".reg_chart_index").parent().css("display",'block').parent().addClass("active");
        var areaChartData = {
        ...
        $('#daterange-btn').daterangepicker(
            ...
            function (start, end) {
                ...
                $.get("{{route('reg_chart_ajax')}}/"+start.format("YYYY-MM-DD")+"/"+end.format("YYYY-MM-DD"),{"_token":"{{ csrf_token() }}","start":start.format('YYYY-MM-DD'),"end":end.format('YYYY-MM-DD')},function (data) {
