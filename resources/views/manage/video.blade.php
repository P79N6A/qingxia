            ...
            <div class="box-body" id="video_list">
                ...
                <div class="col-md-3">
                        <div class="box box-warning">
                            <div class="box-header with-border">
                                <span class="box-title video_title" title="{{ $data['book_list']->find($video->book_id)->bookName }}"><small class="label pull-left bg-red ">{{ $video->num }}</small>{{ str_limit($data['book_list']->find($video->book_id)->bookName,20,'...') }}</span>
                        ...
                        <div class="box-body">
                            <div align="center">
                                <div class="player">
                                <a class="thumbnail book_cover" href="{{ route('video_book_show',$video->book_id) }}">
                                    <img class="book_cover" src="{{ $data['book_list']->find($video->book_id)->picture }}" />
                                </a>
                                </div>
                            </div>
                        </div>
