...
<section class="content">
    ...
    <div class="box box-default color-palette-box">
        ...
        <div class="box-body">
            <div class="book-chapter-right hide"  id="book-chapter-box">
            ...
            <ul class="nav nav-tabs">
                <li><a href="{{ route('workbook_edit_only',[$onlycode,1]) }}">练习册整理</a></li>
            </ul>
                @if($edits->total()>0)
                @foreach($edits as $edit)
                    ...
                    <div class="col-md-3 col-xs-6 pull-left edit_box" data-id="{{ $edit->id }}" style="font-size: 12px;margin-bottom: 10px">
                        ...
                        <div class="input-group" style="width:100%">
                            ...
                            <select data-name="version_year" style="width:25%" class="update_data form-control select2"
                        ...
                        {{--</select>--}}
                        <input class="form-control" name="sort_name" value="{{ $edit->sort_name }}" />
                        </div>
                        ...
                        <div class="input-group" style="width:100%">
                            ...
                            <select data-name="subject_id" class="update_data form-control select2" style="width:25%" tabindex="-1" aria-hidden="true">
