...
spot.$edSpot.html('<input class="timu_sort hide" value='+Draw.indexsort+' type="text"><input class="hide timu_page" value='+pageval+' type="text"><a class="btn btn-xs btn-danger pull-right ocr_btn" data-id='+Draw.indexsort+'>识别</a>');
        //select when mouse down
