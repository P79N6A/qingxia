    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="@yield('new_buy_record')"><a href="{{ route('new_buy_record') }}"><i class="fa fa-th-large"></i> <span>待买列表</span></a></li>
                <li class="@yield('new_buy_analyze')"><a href="{{ route('new_buy_analyze') }}"><i class="fa fa-th-large"></i> <span>待解析列表</span></a></li>
                <li class="@yield('all_repeat_book')"><a href="{{ route('new_buy_repeat_list') }}"><i class="fa fa-shopping-cart"></i> <span>重复课本整理</span></a></li>@endcan
                ...
                <li class="@yield('baidu_manage')"><a href="{{ route('baidu_manage') }}"><i class="fa fa-user"></i> <span>百度统计</span></a></li>
                    <li class="@yield('new_book_buy')"><a href="{{ route('new_book_buy') }}"><i class="fa fa-shopping-cart"></i> <span>练习册收藏统计</span></a></li>
                    ...
                    <li class="@yield('all_new_index')"><a href="{{ route('new_index_all') }}"><i class="fa fa-shopping-cart"></i> <span>单本统计</span></a></li>
                @endcan
            </ul>
        </section>
    </aside>
