           ...
           <div class="col-md-12">
                <div class="input-group col-md-6">
                    <select id="sort_id" class="form-control sort_name click_to">
                        <option value="<?php echo e(cache('all_sort_now')->where("id",$data['sort'])->first()->id); ?>">
                            <?php 
                ...
                <table class="table table-striped">
                    ...
                    <?php $__currentLoopData = $data['list']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr data-oid="<?php echo e($v->id); ?>">
                            ...
                            <td><?php echo e($v->searchnum); ?></td>
                            <td>
                                <?php if($v['answer_status']==1): ?>
                                    有答案
                                <?php elseif($v['answer_status']==2): ?>
                                    有部分答案
                                <?php elseif($v['answer_status']==3): ?>
                                   无答案
                                <?php endif; ?>
                            </td>
                            <td><?php echo e($v->collect2018); ?></td>
                            <td><?php echo e($v->collect2017); ?></td>
                            <td><?php echo e($v->collect2016); ?></td>
                            <td><?php echo e($v->collect2015); ?></td>
                        </tr>
    ...
    <script>
        $(function () {
            ...
            $('#search_book_btn').click(function () {
                ...
                window.location.href='<?php echo e(route('book_list')); ?>'+'/'+sort_id+'/'+volumes_id+'/'+word;
            });



            $('#volumes_sel').val('<?php echo e($data['volumes_id']); ?>');
            $('#search_word').val('<?php echo e($data['word']); ?>');
        })
    </script>
